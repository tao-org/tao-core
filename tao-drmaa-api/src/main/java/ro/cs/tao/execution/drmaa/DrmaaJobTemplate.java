 ...
 * @version 1.0
 */
public class DrmaaJobTemplate implements JobTemplate {
    ...
    */
    ...
    /**
     * Creates a new instance of DrmaaJobTemplate
     * @param session the associated AbstractSession object
     * @param id the table index of the native job template
     */
    protected DrmaaJobTemplate(AbstractSession session, int id) {
    ...
    public int getJobSubmissionState() throws DrmaaException {
        ...
        if (stateString == null || stateString[0].isEmpty() || stateString[0].equals(ACTIVE_STRING)) {
            return ACTIVE_STATE;
    ...
    /**
     * Uses the AbstractSession instance to get the attribute value from the native
     * job template asssociated with this DrmaaJobTemplate instance.
     */
    ...
    /**
     * Uses the AbstractSession instance to set the attribute in the native job
    ...
    /**
     * Uses the AbstractSession instance to set the vector attribute in the native
     * job template asssociated with this DrmaaJobTemplate instance.
     */
    ...
    /**
     * Tests whether this DrmaaJobTemplate represents the same native job
     * template as the given object.  This implementation means that even if two
     * DrmaaJobTemplate instance's have all the same settings, they are not
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DrmaaJobTemplate) {
            return (this.getId() == ((DrmaaJobTemplate)obj).getId());
        } else {
            return false;
        }
    }
