...
public abstract class AbstractSession implements Session {
    ...
    public JobTemplate createJobTemplate() throws DrmaaException {
        ...
        return new DrmaaJobTemplate(this, id);
    }
    ...
    public void deleteJobTemplate(JobTemplate jt) throws DrmaaException {
        ...
        } else if (jt instanceof DrmaaJobTemplate) {
            nativeDeleteJobTemplate(((DrmaaJobTemplate)jt).getId());
        } else {
    ...
    public String runJob(JobTemplate jt) throws DrmaaException {
        if (jt == null) {
            ...
            return this.nativeRunJob(((DrmaaJobTemplate)jt).getId());
        } else {
            throw new InvalidJobTemplateException();
        }
    }
    ...
    public JobInfo wait(String jobId, long timeout) throws DrmaaException {
        DrmaaJobInfo jobInfo = this.nativeWait(jobId, timeout);
     ...
     * Calls drmaa_wait().
     */
    protected native DrmaaJobInfo nativeWait(String jobId, long timeout) throws DrmaaException;
    ...
    public native String[] nativeGetAttributeNames(int jtId) throws DrmaaException;
     ...
     * @param jtId the table index for the native job template
     */
    public native String[] nativeGetAttribute(int jtId, String name) throws DrmaaException;
     ...
     * @param jtId the table index for the native job template
     */
    public native void nativeDeleteJobTemplate(int jtId) throws DrmaaException;
}
