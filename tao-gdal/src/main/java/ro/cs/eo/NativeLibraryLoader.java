...
/**
 * NativeLibraryLoader class used on auxdata/gdal/NativeLibraryLoader.jar
 *
 * Note. The name and access modifier are changed to prevent loading by application Classloader, to be loaded by custom Classloader 'GDALLoaderClassLoader' from NativeLibraryLoader.jar
 */
...
/*
    ...
    3) cd "./tmp"
    4) jar cf "../../../../../resources/auxdata/gdal/NativeLibraryLoader.jar" *
    5) cd "../"
    6) rmdir /q/s "./tmp"
 */
