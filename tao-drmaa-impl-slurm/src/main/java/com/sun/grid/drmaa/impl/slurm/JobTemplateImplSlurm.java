 ...
 * @version 1.0
 */
public class JobTemplateImplSlurm extends com.sun.grid.drmaa.impl.JobTemplateImpl {
    private SessionImplSlurm session;

    private JobTemplateImplSlurm(SessionImpl session, int id) {
        super(session, id);
        this.session = (SessionImplSlurm)session;
        this.id = id;
    }
}
