...
@XmlRootElement(name = "wmsComponent")
public class WMSComponent extends TaoComponent {
    ...
    @Override
    public WMSComponent clone() throws CloneNotSupportedException {
        final WMSComponent cloned = new WMSComponent();
