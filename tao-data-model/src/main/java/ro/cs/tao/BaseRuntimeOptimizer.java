...
public abstract class BaseRuntimeOptimizer implements RuntimeOptimizer {
    ...
    public ProcessingComponent aggregate(ProcessingComponent... sources) throws AggregationException {
        ...
        if (sources != null && sources.length > 0) {
            if (sources.length == 1) {
                ...
                aggregator = createAggregatedComponent(sources);
            }
        }
        return aggregator;
    }
     ...
     */
    protected abstract ProcessingComponent createAggregatedComponent(ProcessingComponent... sources) throws AggregationException;
}
