...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeControl
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeExit
...
JNIEXPORT jstring JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeGetContact
  (JNIEnv *env, jobject object)
{
   char error[DRMAA_ERROR_STRING_BUFFER + 1];
   int errnum = DRMAAJ_ERRNO_SUCCESS;
...
JNIEXPORT jstring JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeGetDRMSInfo
  (JNIEnv *env, jobject object)
{
   char error[DRMAA_ERROR_STRING_BUFFER + 1];
   int errnum = DRMAAJ_ERRNO_SUCCESS;
...
JNIEXPORT jint JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeGetJobProgramStatus
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeInit
...
JNIEXPORT jobjectArray JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeRunBulkJobs
...
JNIEXPORT jstring JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeRunJob
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeSynchronize
...
JNIEXPORT jobject JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeWait
...
JNIEXPORT jint JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeAllocateJobTemplate
  (JNIEnv *env, jobject object)
{
   char error[DRMAA_ERROR_STRING_BUFFER + 1];
   int errnum = DRMAAJ_ERRNO_SUCCESS;
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeSetAttributeValue
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeSetAttributeValues
...
JNIEXPORT jobjectArray JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeGetAttributeNames
  (JNIEnv *env, jobject object, jint id)
{
   char error[DRMAA_ERROR_STRING_BUFFER + 1];
   int errnum = DRMAAJ_ERRNO_SUCCESS;
...
JNIEXPORT jobjectArray JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeGetAttribute
...
JNIEXPORT void JNICALL Java_com_sun_grid_drmaa_torque_SessionImpl_nativeDeleteJobTemplate
  (JNIEnv *env, jobject object, jint id)
{
   char error[DRMAA_ERROR_STRING_BUFFER + 1];
   int errnum = DRMAAJ_ERRNO_SUCCESS;
