 ...
 *
 * @see Session
 * @see com.sun.grid.drmaa.torque.JobTemplateImpl
...
public class SessionImpl implements Session {
    ...
    private static final String libraryName = "libdrmaa-jni-torque.so";
    private static final String loadingLibraryName = "drmaa-jni-torque";
    ...
    private static void copyFiles() throws IOException{
        ...
        try{
            ...
            if (source.isDirectory()){
                ...
                throw new IOException(resourceFolder + " is not a folder");
            }
            for(File file : files){
